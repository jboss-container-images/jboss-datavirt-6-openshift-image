...
LINKS =  {"jboss-datavirt64-openshift:1.5": "../../datavirt/datavirt-openshift{outfilesuffix}[`jboss-datavirt-6/datavirt64-openshift`]",
}
...
def generate_readme():
    ...
    with open('docs/README.adoc','w') as fh:
        ...
        # release notes
        fh.write(open('./docs/release-notes.adoc.in').read())
